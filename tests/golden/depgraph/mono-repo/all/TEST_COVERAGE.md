...
- `packages/cli/src/format.ts` → Expected test: `tests/unit/cli/format.test.ts`
- `packages/cli/src/main.ts` → Expected test: `tests/unit/cli/main.test.ts`
